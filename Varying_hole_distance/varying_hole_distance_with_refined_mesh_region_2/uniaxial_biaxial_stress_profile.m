...
for cont=1:2:t
    ...
    %plotstyle1={'k-','b-','g-','r-','y-','m-','c-','k-','b-','g-','r-','y-','m-','c-','k-','b-','g-','r-','y-','m-','c-','k-','b-','g-','r-','y.','m-','c-','k-','k-','b-','g-','r-','y-','m-','c-','k-','b-','g-','r-','y-','m-','c-','k-','b-','g-','r-','y-','m-','c-','k-'}; 
    diff=[6.5:0.5:20]; %Point differences to be read
    [m n] = size(diff);
    ...
    saveas(figure(temp),[pwd '/plots/plot_',axial{cont},'_number_',num2str(cont),'.png']);
    saveas(figure(temp),[pwd '/plots/plot_',axial{cont},'_number_',num2str(cont),'.fig']);

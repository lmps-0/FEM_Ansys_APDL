! VARYING HOLE DISTANCE (07/12/2017) SIGMA Y, code repairs in (26/01/2018), varying_hole_distance_plate_1.5_depth_1.5_refined_mesh_region_ring
...
!*enddo
				...
				*dim,wd,string,200,1
				wd(1,1)='C:\Manasses\varying_hole_distance_plate_1.5_depth_1.5_refined_mesh_region_ring\uniaxial'
				...
				diff = 5.5 !mínimo 5.0 mm -> ring problem
				inicial = 25
				final = 55
				incr = 5
...
*do,diff,inicial,final,incr
	...
	*endif
	...
	parres,new,parameters,txt,'C:\Manasses\varying_hole_distance_plate_1.5_depth_1.5_refined_mesh_region_ring\uniaxial'
	...
	!INÍCIO DO BLOCO DE COMANDO DENTRO DO LOOP
		...
		*get,n_area,area,0,num,max
		...
		vsba,volume10,n_area,,delete,keep 
		!vdele,1
		allsel
		vplot
		save

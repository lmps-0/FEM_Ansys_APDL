! VARYING HOLE DISTANCE (26/01/2018) BIAXIAL varying_hole_distance_plate_1.5_depth_1.5_refined_mesh_region_ring
...
!*enddo
				...
				*dim,wd,string,200,1
				wd(1,1)='C:\Manasses\varying_hole_distance_plate_1.5_depth_1.5_refined_mesh_region_ring\biaxial'
...
*do,diff,inicial,final,incr
	...
	*endif
	...
	parres,new,parameters,txt,'C:\Manasses\varying_hole_distance_plate_1.5_depth_1.5_refined_mesh_region_ring\biaxial'

! VARYING HOLE DISTANCE (07/12/2017)
...
*enddo
				...
				*dim,wd,string,200,1
				wd(1,1)='C:\Manasses\varying_hole_distance_with_refined_mesh_region\biaxial'
...
*do,diff,inicial,final,incr
	...
	parres,new,parameters,txt,'C:\Manasses\varying_hole_distance_with_refined_mesh_region\biaxial'
	...
	!INÍCIO DO BLOCO DE COMANDO DENTRO DO LOOP
		...
		*get,n_area,area,0,num,max
		...
		vsba,all,n_area,,delete,keep ! ATENÇÃO 
		!vdele,1
		allsel
		vplot
		save
		...
		asel,s,loc,x,x1
		vsla,s,0
		*get,volume_1,volu,0,num,max
		asel,s,loc,x,x2/2
		vsla,s,0
		*get,volume_2,volu,0,num,max
		allsel
		vsel,u,volu,,volume_1
		vsel,u,volu,,volume_2
		size_refined= 0.2
		esize,size_refined
		vmesh,all
		allsel

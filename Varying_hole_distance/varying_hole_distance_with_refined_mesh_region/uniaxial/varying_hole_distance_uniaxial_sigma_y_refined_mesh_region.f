...
!*enddo
				...
				*dim,wd,string,200,1
				wd(1,1)='C:\Manasses\varying_hole_distance_with_refined_mesh_region\uniaxial'
...
*do,diff,inicial,final,incr
	...
	parres,new,parameters,txt,'C:\Manasses\varying_hole_distance_with_refined_mesh_region\uniaxial'

! VARYING HOLE DISTANCE (19/12/2017) SIGMA Y - varying_hole_distance_plate_1.5_depth_1_refined_mesh_region_ring - uniaxial
...
*enddo
				...
				*dim,wd,string,200,1
				wd(1,1)='C:\Manasses\varying_hole_distance_plate_1.5_depth_1_refined_mesh_region_ring\uniaxial'
...
*do,diff,inicial,final,incr
	...
	*endif
	...
	parres,new,parameters,txt,'C:\Manasses\varying_hole_distance_plate_1.5_depth_1_refined_mesh_region_ring\uniaxial'

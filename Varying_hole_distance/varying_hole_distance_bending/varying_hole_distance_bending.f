! VARYING HOLE DISTANCE (08/02/2018) BENDING - varying_hole_distance_plate_1.5_depth_1
...
!*enddo
				...
				*dim,wd,string,200,1
				!wd(1,1)='C:\Manasses\varying_hole_distance_bending\bending_uniaxial'
				wd(1,1)='C:\Manasses\varying_hole_distance_bending\bending_biaxial'
...
*do,diff,inicial,final,incr
	...
	*endif
	...
	!parres,new,parameters,txt,'C:\Manasses\varying_hole_distance_bending\bending_uniaxial'
	parres,new,parameters,txt,'C:\Manasses\varying_hole_distance_bending\bending_biaxial'
